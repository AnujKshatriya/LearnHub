  ...
  return (
    <div className='main'>
      <div className="main-text">
        ...
        <p > We know wading through endless YouTube videos can be a time-suck. That's why an IIT Gandhinagar graduate who is also a JEE Mentor at Physics Wallah has curated the best ones for you. Now,<span> focus on what matters </span>– mastering the concepts and acing your exams <span>!</span></p>
      </div>
